...
private:
	...
	std::map <Coordinate, char> findEnemies(void); //for debugging. Add the enemie's locations in the txt file and call this fn to accuratly determine spawn points for enemies in levelOne
